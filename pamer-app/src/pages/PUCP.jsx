    ...
    <div>
      ...
      <div className="max-w-screen-xl mx-auto mb-8 w-3/4">
        <Slider {...settings} className="w-full">
          <div>
            <img src="/pucp1.webp" alt="UNMSM Banner 1" className="w-full h-auto object-contain" style={{ maxHeight: '300px' }} />
          </div>
          <div>
            <img src="/pucp2.webp" alt="UNMSM Banner 2" className="w-full h-auto object-contain" style={{ maxHeight: '300px' }} />
          </div>
        </Slider>
      </div>
      ...
      <div className="max-w-screen-lg mx-auto px-4 py-8 bg-gray-100 rounded-lg shadow-lg">
        ...
        <div className="flex items-center mb-4 space-x-4">
          ...
          <p>Dirigido a estudiantes que buscan una formación integral basada en la excelencia académica.</p>
        </div>
        <div className="flex items-center mb-4 space-x-4">
          <FaMapMarkerAlt className="text-2xl text-gray-700" />
          <p>Sedes: Lima, San Miguel.</p>
        </div>
        <div className="flex items-center mb-4 space-x-4">
